$("document").ready(function () {
  ...
  function skipToEnd(message) {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν μπορείτε να βγάλετε πιστοποιητικό αναπηρίας!"
        : "We are sorry, but you cannot obtain a disability certification!";
  ...
  function retrieveAnswers() {
    ...
    //  getEvidencesById(1);
    //}
    if ((allAnswers[2] === "2") || (allAnswers[2] === "3") || (allAnswers[2] === "4")) {
      getEvidencesById(2);
    }
    if (allAnswers[3] === "2") {
      getEvidencesById(3);
    } else if (allAnswers[3] === "3") {
      getEvidencesById(5);
    }
    if (allAnswers[4] === "1") {
      getEvidencesById(4);
